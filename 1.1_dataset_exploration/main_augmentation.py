...
def main():
    ...
    data_dir = "./AMLS_Exercise/1.1_dataset_exploration/data"
    X_train_split, X_val_split, y_train_split, y_val_split = load_split_data("./AMLS_Exercise/1.1_dataset_exploration/data/split_data.pkl")
    base_dir = "./AMLS_Exercise/1.1_dataset_exploration"
