...
def main():
    ...
    data_dir = "./AMLS_Exercise/1.2_and_3_tuning_and_augmentation/data"
    X_train_split, X_val_split, y_train_split, y_val_split = load_split_data("1.2_and_3_tuning_and_augmentation/data/split_data.pkl")
    base_dir = "./AMLS_Exercise/1.2_and_3_tuning_and_augmentation"
